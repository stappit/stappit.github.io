...
Here's my solution to exercise 9, chapter 3, of [Gelman's](https://andrewgelman.com/) *Bayesian Data Analysis* (BDA), 3rd edition. There are [solutions](http://www.stat.columbia.edu/~gelman/book/solutions.pdf) to some of the exercises on the [book's webpage](http://www.stat.columbia.edu/~gelman/book/).
...
<div style="display:none">
  $\DeclareMathOperator{\dbinomial}{Binomial}
   ...
   \DeclareMathOperator{\dinvchi2}{Inv$\chi^2$}
   \DeclareMathOperator{\dnorminvchi2}{Norm-Inv$\chi^2$}
